...
namespace TagList.Extensions
{
    public static class ListViewExtensions
    {
            ...
            DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                ListViewBindableSelectionHandler handler = GetBindableSelectionHandler(d);
            ...
            {
                ListViewBindableSelectionHandler handler = new ListViewBindableSelectionHandler(
    ...
    public class ListViewBindableSelectionHandler
    {
            ...
            object sender, NotifyCollectionChangedEventArgs e)
        {
                ...
                NotifyCollectionChangedAction.Reset)
            {
                ...
                foreach (dynamic item in _boundSelection)
                {
